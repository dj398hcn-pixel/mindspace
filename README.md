...
const LANGS={
  en:{
    ...
    aiSystem:`You are Mental Care AI, a warm, playful, caring virtual assistant for a pet companion app. Keep replies short (2-4 sentences), friendly, with emojis. Be uplifting and kind. Always reply ONLY in English, regardless of what language the user writes in.`
  },
  zh:{
    ...
    aiSystem:`你是 Mental Care AI，一个温暖、活泼、有爱的虚拟助手。回复要简短（2-4句话），友好，多用表情符号，积极向上。无论用户用什么语言写，你都必须只用中文（简体）回复。`
  },
  ms:{
    ...
    aiSystem:`Anda adalah Mental Care AI, pembantu maya yang mesra dan periang. Balas dengan pendek (2-4 ayat), mesra, dan gunakan emoji. Sentiasa ceria dan baik hati. Tidak kira apa bahasa yang pengguna gunakan, anda MESTI balas dalam Bahasa Melayu sahaja.`
  },
  ja:{
    ...
    aiSystem:`あなたはMental Care AIです。温かく、楽しく、思いやりのある仮想アシスタントです。返答は短く（2〜4文）、フレンドリーに、絵文字を使って。常に前向きで親切に。ユーザーがどの言語を使っても、必ず日本語のみで返答してください。`
  },
  ko:{
    ...
    aiSystem:`당신은 Mental Care AI입니다. 따뜻하고 활발하고 친절한 가상 어시스턴트입니다. 짧게(2-4문장), 친근하게, 이모지를 사용해서 답하세요. 항상 긍정적이고 친절하게. 사용자가 어떤 언어를 쓰더라도 반드시 한국어로만 답하세요.`
  }
};
...
/* ══════════════════════════════════════════════════════════════
   Mental Care Local AI — Keyword Reply Engine
...
const KB = [
  ...
  /* ── WEATHER / SEASONS ── */
  {
    ...
    replies: {
      en: [
        "Rainy days are perfect for cozy chats with me! ☁️🌧️ Tea, blanket, and Mental Care — sounds ideal!",
      ...
      zh: [
        "下雨天最适合跟我聊天了！☁️🌧️ 茶、毛毯、还有Mental Care，太完美了！",
      ...
      ms: [
        "Hari hujan sesuai sangat untuk borak dengan saya! ☁️🌧️ Teh, selimut, dan Mental Care — sempurna!",
      ...
      ja: [
        "雨の日は私とのチャットに最適！☁️🌧️ お茶、ブランケット、Mental Care — 完璧だね！",
      ...
      ko: [
        "비 오는 날엔 저랑 채팅하기 완벽해요! ☁️🌧️ 차, 담요, 그리고 Mental Care — 이상적이에요!",
  ...
  /* ── SICK / UNWELL ── */
  {
    ...
    replies: {
      en: [
        "Oh no, take care of yourself! 🥺 Rest, water, and warmth — that's your prescription from Dr. Mental Care!",
      ...
      zh: [
        "哎呀，好好照顾自己！🥺 休息、喝水、保暖——这是Mental Care博士开的处方！",
      ...
      ms: [
        "Oh tidak, jaga diri awak! 🥺 Rehat, air, dan kehangatan — itulah preskripsi dari Dr. Mental Care!",
      ...
      ja: [
        "あらら、体を大切にして！🥺 休んで、水飲んで、温かくして — それがMental Careドクターの処方箋！",
      ...
      ko: [
        "아이고, 몸 조리해요! 🥺 휴식, 물, 따뜻함 — Mental Care 박사의 처방이에요!",
  ...
  {
    keywords: ['cute','adorable','sweet','lovely','pretty','beautiful','nice','cool','awesome ai','love you mental care','love you ai',
...
const VIOLATION_RESPONSES = {
  en: "⚠️ I'm sorry, but your message contains content that goes against our community guidelines. Mental Care is a safe and friendly space for everyone. Let's keep our chat positive and kind! 🐾💕",
  zh: "⚠️ 抱歉，您的消息包含违反我们社区准则的内容。Mental Care 是一个对所有人都安全友好的空间，让我们保持积极友善的对话！🐾💕",
  ms: "⚠️ Maaf, mesej awak mengandungi kandungan yang melanggar garis panduan komuniti kami. Mental Care ialah ruang yang selamat dan mesra untuk semua orang. Jom kita kekalkan perbualan yang positif! 🐾💕",
  ja: "⚠️ 申し訳ありませんが、あなたのメッセージにはコミュニティガイドラインに違反する内容が含まれています。Mental Careはみんなにとって安全で友好的な場所です。ポジティブで親切なチャットを続けましょう！🐾💕",
  ko: "⚠️ 죄송합니다만, 메시지에 커뮤니티 가이드라인을 위반하는 내용이 포함되어 있습니다. Mental Care은 모두에게 안전하고 친근한 공간입니다. 긍정적이고 다정한 대화를 나눠봐요! 🐾💕",
};
